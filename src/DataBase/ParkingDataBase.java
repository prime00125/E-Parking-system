...
public class ParkingDataBase
{
       public static Connection setConnection()
               {
                   String url = "jdbc:ucanaccess://D://working//Parking-Management-System-master//src//DataBase//parking.accdb";
                   Connection con = null;
                   try
                   {
       ...
       public int getID(String TableName)
       {
           ...
           try
           {
               try (Statement st = con.createStatement(); ResultSet rs = st.executeQuery("SELECT * FROM "+TableName+"")) {
                   while(rs.next())
                   {
                       k++;
                   }
